  ...
  <div id="login">
    ...
    <div id="loginBox">
      ...
      >
        ...
        <el-form-item label="" prop="verificateCode">
          <el-row>
            <el-col :span="2">
            ...
            <el-col :span="22">
              <el-input
                class="inps"
                placeholder="验证码"
                v-model="loginForm.verificateCode"
              ></el-input>
              <img :src="yzm" class="yzmImg" @click="verifity()" />
            </el-col>
            
          </el-row>
        </el-form-item>
        <el-form-item style="margin-top: 55px">
          <el-button type="primary" round class="submitBtn" @click="userLogin()"
            >登录</el-button
          >
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    verifity() {
      ...
      this.$axios
        .get("/api/login/getVerify?date=" + date, {
    ...
    userLogin(){
      let params = {
        verify : this.loginForm.verificateCode
      }
      let data = {
...
#login {
  ...
  background-size: 100%;
  background-image: url("../assets/static/images/Starry.png");
  position: relative;
  #bgd {
    height: 100vh;
    width: 100vw;
